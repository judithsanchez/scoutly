...
function updateCompanyRankings() {
    return __awaiter(this, void 0, void 0, function () {
        var companies, _i, companies_1, company, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    companies = _a.sent();
                    console.log("Found ".concat(companies.length, " companies to update"));
                    _i = 0, companies_1 = companies;
                    _a.label = 3;
                case 3:
                    if (!(_i < companies_1.length)) return [3 /*break*/, 6];
                    company = companies_1[_i];
                    return [4 /*yield*/, companyService_1.CompanyService.updateCompanyRanking(company.companyID, 75)];
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5:
                ...
                case 7:
                    error_1 = _a.sent();
                    console.error('Error updating company rankings:', error_1);
