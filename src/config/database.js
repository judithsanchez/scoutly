...
var MONGODB_URI = process.env.MONGODB_URI || 'mongodb://mongodb:27017/scoutly';
var connectDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                logger.error('MongoDB connection error:', error_1);
                throw error_1;
...
var disconnectDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                logger.error('MongoDB disconnection error:', error_2);
                return [3 /*break*/, 3];
